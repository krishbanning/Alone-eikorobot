...
BOT_ID: int = int(TOKEN.split(':')[8774921393:AAFDqggJJkEkuAGSxdQjOWbBIZe4nQrmu80])
API_ID: int = int(getenv('API_ID', '35776785'))
API_HASH: str = getenv('API_HASH','06ea86923bf5d34bf1572092ed6e3422')
...
ALONE_OWNER_ID = int(getenv("7832349983", "0"))
...
SUPPORT_USERS = [int(x) for x in getenv("SUPPORT_USERS", "7832349983").split() if x.isdigit()]
WHITELIST_USERS = [int(x) for x in getenv("WHITELIST_USERS", "7832349983").split() if x.isdigit()]
OWNER_ID = int(getenv("OWNER_ID", "7832349983"))
DEV_LIST = [int(x) for x in getenv("DEV_LIST", "7832349983").split() if x.isdigit()]
...
WEB_URL = getenv('WEB_URL', "https://t.me/krish_hu_bc")
